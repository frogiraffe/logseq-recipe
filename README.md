...
<!-- TODO(release-blocker): capture these against a released Logseq DB build
     before submitting to the Marketplace. See docs/RELEASE_VALIDATION.md for
     the capture checklist. Until then these are real image links pointing at
     files that don't exist yet, not placeholder text. -->

| Recipe Card | Serving scaling | Cooking Mode |
| --- | --- | --- |
| ![Recipe Card](docs/screenshots/recipe-card.png) | ![Serving scaling](docs/screenshots/serving-scaling.png) | ![Cooking Mode](docs/screenshots/cooking-mode.png) |
