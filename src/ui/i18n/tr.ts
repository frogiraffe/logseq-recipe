...
export const trMessages: UiMessages = {
  ...
  deleteRecipeConfirm:
    "Bu tarif silinsin mi? Logseq sayfayı hemen tamamen silmek yerine geri dönüşüme gönderir, ancak sayfa grafiğinizden ve bu listeden kaybolur.",
  deleteRecipeConfirmAction: "Sil",
